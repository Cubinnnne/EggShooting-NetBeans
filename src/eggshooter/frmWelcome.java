...
public class frmWelcome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        prgLoading.setForeground(new java.awt.Color(255, 153, 0));
        prgLoading.setStringPainted(true);
        getContentPane().add(prgLoading, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 400, 20));

        lblBall.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblBall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/loadingball.gif"))); // NOI18N
        getContentPane().add(lblBall, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 400, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/EggShooter.png"))); // NOI18N
    ...
    public javax.swing.JLabel lblBall;
